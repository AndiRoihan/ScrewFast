export const Icons = {
  ...
  halal: {
    paths: [
      {
        d: "M21,2a1,1,0,0,0-1,1v7H15.909a5.672,5.672,0,0,0,.9-1.75c.538-1.677,0-3.75-2.4-5L12,2h0L9.6,3.25c-2.4,1.25-2.942,3.323-2.4,5a5.672,5.672,0,0,0,.9,1.75H4V3A1,1,0,0,0,2,3V22h8V18a2,2,0,0,1,4,0v4h8V3A1,1,0,0,0,21,2ZM8,18H4V16H8Zm12,0H16V16h4Zm0-4H4V12H20Z",
      },
    ],
    class: "mt-1 h-8 w-8 shrink-0 fill-orange-400 dark:fill-orange-300",
    width: 24,
  ...
  frame: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 stroke-orange-400 dark:stroke-orange-300",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
